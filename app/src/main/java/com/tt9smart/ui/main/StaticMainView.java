...
public class StaticMainView {
	...
	protected BaseMainLayout getViewInstance(SettingsStore settings) {
		if (settings.isMainLayoutSmall() && (main == null || !main.getClass().equals(MainLayoutSmall.class))) {
		...
		} else if (settings.isMainLayoutSmartBar() && (main == null || !main.getClass().equals(MainLayoutSmartBar.class))) {
			return new MainLayoutSmartBar(tt9);
