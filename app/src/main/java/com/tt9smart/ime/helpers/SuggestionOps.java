...
import com.tt9smart.hacks.AppHacks;
...
import com.tt9smart.ui.main.ResizableMainView;
import com.tt9smart.ui.tray.StatusBar;
import com.tt9smart.ui.tray.SuggestionsBar;
...
public class SuggestionOps {
	...
	public void setBarVisible(boolean visible) {
		if (suggestionBar != null) {
			suggestionBar.setVisible(visible);
		}
		if (statusBar != null) {
			statusBar.setShown(!visible);
		}
	}
