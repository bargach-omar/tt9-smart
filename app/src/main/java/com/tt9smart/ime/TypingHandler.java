...
import com.tt9smart.ime.helpers.CursorOps;
import com.tt9smart.ime.helpers.InputConnectionAsync;
...
import com.tt9smart.ime.helpers.TextSelection;
import com.tt9smart.ime.mindreader.MindReader;
...
public abstract class TypingHandler extends KeyPadHandler {
	...
	protected int determineInputModeId() {
		...
		int savedMode = settings.isMainLayoutSmartBar() ? InputMode.MODE_ABC : settings.getInputMode();
		return InputModeValidator.validateMode(savedMode, allowedInputModes);
	}
