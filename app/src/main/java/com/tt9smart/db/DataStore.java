...
import com.tt9smart.db.wordPairs.WordPairStore;
import com.tt9smart.db.words.WordStore;
...
import com.tt9smart.util.SupremeExecutor;
...
public class DataStore {
	...
	public static void getWordsByPrefix(Consumer<ArrayList<String>> dataHandler, Language language, String prefix, int maxWords) {
		runInThread(() -> {
			ArrayList<String> data = words.getByPrefix(language, prefix, maxWords);
