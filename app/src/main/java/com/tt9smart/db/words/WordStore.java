...
import com.tt9smart.db.BaseSyncStore;
import com.tt9smart.db.entities.AddWordResult;
import com.tt9smart.db.entities.CustomWord;
import com.tt9smart.db.entities.NormalizationList;
import com.tt9smart.db.entities.Word;
import com.tt9smart.db.entities.WordList;
import com.tt9smart.db.sqlite.DeleteOps;
import com.tt9smart.db.sqlite.InsertOps;
import com.tt9smart.db.sqlite.ReadOps;
import com.tt9smart.db.sqlite.UpdateOps;
import com.tt9smart.db.sqlite.WordDbOpener;
import com.tt9smart.languages.Language;
import com.tt9smart.languages.NullLanguage;
import com.tt9smart.preferences.settings.SettingsStore;
import com.tt9smart.util.Logger;
import com.tt9smart.util.Text;
import com.tt9smart.util.Timer;
...
public class WordStore extends BaseSyncStore {
	...
	@NonNull public ArrayList<String> getByPrefix(Language language, String prefix, int maxWords) {
		return checkOrNotify() ? readOps.getWordsByPrefix(sqlite.getDb(), language, prefix, maxWords) : new ArrayList<>();
	}
